...
var zhTranslations = map[string]string{
	...
	"branch.label.local":               "(本地)",
	"branch.label.remote":              "(远程)",
	"branch.switch.short":              "交互式切换分支",
	"branch.switch.select":             "选择要切换的分支",
	"branch.switch.none":               "没有可切换的分支 (当前已是唯一分支)。",
	"branch.switch.remote.desc":        "自动创建同名本地跟踪分支",
	"branch.switch.dirty.title":        "工作区有未提交修改,如何处理?",
	"branch.switch.dirty.carry":        "携带修改切换",
	"branch.switch.dirty.carry.desc":   "未提交修改跟随到新分支 (文件冲突时会失败)",
	"branch.switch.dirty.stash":        "自动 stash 后恢复",
	"branch.switch.dirty.stash.desc":   "先暂存修改,切换后在新分支恢复;冲突时保留 stash 供手动处理",
	"branch.switch.dirty.cancel":       "取消",
	"branch.switch.dirty.cancel.desc":  "留在当前分支",
	"branch.switch.cancelled":          "已取消切换分支。",
	"branch.switch.loading":            "正在切换到 %s...",
	"branch.switch.success":            "已切换到 %s",
	"branch.switch.stash.push.loading": "正在暂存本地修改...",
	"branch.switch.stash.push.success": "修改已暂存,正在切换到 %s",
	"branch.switch.stash.push.failed":  "暂存修改失败:",
	"branch.switch.stash.pop.loading":  "正在恢复暂存的修改...",
	"branch.switch.stash.pop.success":  "暂存的修改已恢复",
	"branch.switch.stash.pop.conflict": "恢复 stash 失败 (条目已保留,请手动执行 'git stash pop' 处理): 与新分支内容冲突",
	"branch.create.short":              "新建分支并切换",
	"branch.create.name.title":         "新分支名称",
	"branch.create.name.invalid":       "分支名包含非法字符或格式 (空格、..、~ ^ : ? * [ \\ 等)",
	"branch.create.base.select":        "选择创建基点",
	"branch.create.base.head":          "当前 HEAD",
	"branch.create.base.head.desc":     "从当前所在提交创建",
	"branch.create.push.confirm":       "是否推送新分支并设置上游跟踪?",
	"branch.create.loading":            "正在创建分支 %s...",
	"branch.create.success":            "分支 %s 已创建并切换",
	"branch.create.push.loading":       "正在推送 %s 到 %s...",
	"branch.create.push.success":       "%s 已推送到 %s 并设置上游跟踪",

	// Stash management
	"stash.short":             "交互式管理 stash",
	"stash.menu.title":        "Stash 管理",
	"stash.menu.save":         "保存修改到 stash",
	"stash.menu.save.desc":    "将当前未提交修改入栈,可附消息",
	"stash.menu.manage":       "浏览并管理 stash 条目",
	"stash.menu.manage.desc":  "预览改动、应用、应用并删除、删除条目",
	"stash.menu.clear":        "清空全部 stash 条目",
	"stash.menu.clear.desc":   "永久删除所有条目(需确认)",
	"stash.message.input":     "Stash 消息(可选)",
	"stash.push.loading":      "正在保存修改到 stash...",
	"stash.push.success":      "修改已保存到 stash",
	"stash.no.changes":        "没有可暂存的本地修改。",
	"stash.empty":             "当前没有 stash 条目。",
	"stash.select.title":      "选择 stash 条目",
	"stash.action.title":      "选择操作",
	"stash.action.diff":       "查看改动 (diff)",
	"stash.action.diff.desc":  "仅预览内容,不恢复",
	"stash.action.apply":      "应用(保留条目)",
	"stash.action.apply.desc": "恢复改动并保留条目在列表中",
	"stash.action.pop":        "应用并删除 (pop)",
	"stash.action.pop.desc":   "恢复改动并删除条目;冲突时 git 自动保留条目",
	"stash.action.drop":       "删除此条目",
	"stash.action.drop.desc":  "永久移除该条目(需确认)",
	"stash.apply.loading":     "正在应用 %s...",
	"stash.apply.success":     "%s 应用成功",
	"stash.pop.loading":       "正在恢复 %s...",
	"stash.pop.success":       "%s 已恢复并从列表移除",
	"stash.apply.failed":      "应用 stash 失败:",
	"stash.conflict.hint":     "检测到冲突:请手动解决;pop 场景下 git 会自动保留该条目。",
	"stash.drop.confirm":      "确定永久删除 %s ?",
	"stash.drop.loading":      "正在删除 %s...",
	"stash.drop.success":      "%s 已删除",
	"stash.clear.confirm":     "将永久删除全部 %d 条 stash 记录,是否继续?",
	"stash.clear.loading":     "正在清空全部 stash 条目...",
	"stash.clear.success":     "全部 stash 条目已清空",
	"stash.cancelled":         "已取消操作。",
	"stash.diff.title":        "改动内容:",
	"stash.diff.failed":       "查看 stash 改动失败:",
	...
	"amend.staged.extras.warning": "暂存区还有 %d 个未勾选的已暂存文件,将被一并并入上次提交:",
	...
	// Worktree management
	"worktree.short":                 "管理 git 工作树",
	"worktree.menu.title":            "Worktree 管理",
	"worktree.menu.list":             "查看工作树",
	"worktree.menu.list.desc":        "列出全部关联工作树及其分支",
	"worktree.menu.add":              "添加工作树",
	"worktree.menu.add.desc":         "将分支检出到独立目录(可新建或使用已有分支)",
	"worktree.menu.remove":           "删除工作树",
	"worktree.menu.remove.desc":      "删除关联工作树目录(主工作树除外)",
	"worktree.list.title":            "工作树列表:",
	"worktree.tag.main":              "(主)",
	"worktree.tag.bare":              "(裸仓)",
	"worktree.path.input":            "工作树路径",
	"worktree.mode.select":           "选择检出方式",
	"worktree.mode.new":              "新建分支",
	"worktree.mode.new.desc":         "git worktree add -b <分支> <路径>(基于当前 HEAD)",
	"worktree.mode.existing":         "检出已有分支",
	"worktree.mode.existing.desc":    "仅列出未被其他工作树占用的分支",
	"worktree.branch.input":          "新分支名称",
	"worktree.select.branch":         "选择工作树使用的分支",
	"worktree.no.available.branches": "全部分支均已被其他工作树占用。",
	"worktree.add.loading":           "正在创建工作树 %s...",
	"worktree.add.success":           "工作树 %s 已创建(分支 %s)",
	"worktree.select.remove":         "选择要删除的工作树",
	"worktree.none.to.remove":        "没有可删除的工作树(主工作树除外)。",
	"worktree.remove.confirm":        "确定删除 %d 个工作树吗?对应目录将从磁盘移除。",
	"worktree.remove.loading":        "正在移除 %s...",
	"worktree.remove.success":        "%s 已移除",
	"worktree.cancelled":             "已取消操作。",
	...
	"merge.abort.message":                   "合并已中止,仓库已恢复到合并前状态",
	...
	"cherry.pick.resolved":             "冲突解决完成,摘取成功",
	"cherry.pick.abort.message":        "摘取已中止,仓库已恢复到摘取前状态",
	"cherry.pick.stopped":              "已停止剩余摘取任务。",
	"cherry.pick.empty.commit":         "检测到空提交",
	"cherry.pick.empty.commit.skipped": "已跳过(改动已包含在当前 HEAD 中)",
	...
	"op.rebase.name":                   "变基",
	"op.merge.name":                    "合并",
	"op.cherry-pick.name":              "摘取",
	"conflict.loop.detected":           "检测到%s冲突!",
	"conflict.loop.files":              "冲突文件:",
	...
	"conflict.loop.menu.edit.desc":     "用 EDITOR/vim 打开全部冲突文件",
	"conflict.loop.menu.continue":      "已解决,继续",
	"conflict.loop.menu.continue.desc": "暂存冲突文件并执行 --continue(未解决文件按当前内容暂存)",
	"conflict.loop.menu.skip":          "跳过当前提交",
	"conflict.loop.menu.skip.desc":     "放弃该提交的改动 (--skip)",
	"conflict.loop.menu.abort":         "中止操作",
	"conflict.loop.menu.abort.desc":    "恢复到操作前状态 (--abort)",
	"conflict.loop.menu.quit":          "退出,保持挂起",
	"conflict.loop.menu.quit.desc":     "稍后手动解决或再次运行 easyGit",
	"conflict.loop.unresolved.confirm": "部分冲突文件仍含冲突标记(<<<<<<<),确定按当前内容暂存并继续吗？",
	"conflict.loop.git.add.failed":     "暂存冲突文件失败",
	"conflict.loop.quit.error":         "%s 冲突仍未解决:请手动处理或重新运行命令",
