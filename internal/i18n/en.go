...
var enTranslations = map[string]string{
	...
	"stash.diff.title":        "changes:",
	"stash.diff.failed":       "Failed to show stash diff:",
	...
	"amend.staged.extras.warning": "%d additional staged file(s) are NOT selected above and will be included in the amended commit:",
	...
	"cherry.pick.empty.commit.skipped": "Skipped (changes already included in HEAD)",
