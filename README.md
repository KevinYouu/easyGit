...
- ⌨️ **Unified Help Bar** - Every screen shows a single-line shortcut bar with `[Key]` prefix and action text, inline option descriptions (bright name + muted detail), auto-hidden on tiny terminals
