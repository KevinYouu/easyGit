...
var menuItems = []menuItem{
	...
	{key: "stash", label: "stash (st)", descKey: "stash.short", run: func() error { return gitcmd.Stash() }},
	...
	{key: "worktree", label: "worktree (wk)", descKey: "worktree.short", run: func() error { return gitcmd.Worktree() }},
