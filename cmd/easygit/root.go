...
func updateRootCommandDescriptions() {
	...
	for _, cmd := range rootCmd.Commands() {
		...
		case "branch-switch":
			cmd.Short = i18n.T("branch.switch.short")
		case "branch-create":
			cmd.Short = i18n.T("branch.create.short")
		case "stash":
		...
		case "clean":
			cmd.Short = i18n.T("clean.short")
		case "worktree":
			cmd.Short = i18n.T("worktree.short")
		case "merge":
